...
import { Code2, Database, Palette, BarChart3, Brain, Globe, FileText, Users } from 'lucide-react';
const SkillsSection = () => {
  ...
  return <section id="skills" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        once: true
          ...
          {skillCategories.map((category, categoryIndex) => <motion.div key={categoryIndex} variants={cardVariants} whileHover={{
          scale: 1.02
        }}>
                ...
                <div className="space-y-6">
                  {category.skills.map((skill, skillIndex) => <div key={skillIndex}>
                      ...
                      <div className="relative h-3 bg-secondary rounded-full overflow-hidden">
                        <motion.div className={`absolute top-0 left-0 h-full bg-gradient-to-r ${skill.color} rounded-full`} initial={{
                    width: 0
                  }} whileInView={{
                    width: `${skill.level}%`
                  }} transition={{
                    ...
                    once: true
                        ...
                        {/* Glow effect */}
                        <motion.div className={`absolute top-0 left-0 h-full bg-gradient-to-r ${skill.color} rounded-full opacity-50 blur-sm`} initial={{
                    width: 0
                  }} whileInView={{
                    width: `${skill.level}%`
                  }} transition={{
        ...
        once: true
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            desc: "Building predictive models"
          }, {
            icon: Database,
            ...
            desc: "Documentation & communication"
          }, {
            icon: Users,
